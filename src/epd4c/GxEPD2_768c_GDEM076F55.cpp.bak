...
#include "GxEPD2_768c_GDEM076F55.h"

/**
 * @brief 构造函数，初始化GxEPD2_768c_GDEM076F55对象
 */
GxEPD2_768c_GDEM076F55::GxEPD2_768c_GDEM076F55(int16_t cs, int16_t dc, int16_t rst, int16_t busy) :
 ...
 * @brief 选择快速全屏更新模式
 */
void GxEPD2_768c_GDEM076F55::selectFastFullUpdate(bool ff)
{
 ...
 * @brief 使用单一颜色值清屏
 */
void GxEPD2_768c_GDEM076F55::clearScreen(uint8_t value)
{
 ...
 * @brief 使用指定的黑白值清屏
 */
void GxEPD2_768c_GDEM076F55::clearScreen(uint8_t black_value, uint8_t color_value)
{
 ...
 * @brief 将指定值写入屏幕缓冲区
 */
void GxEPD2_768c_GDEM076F55::writeScreenBuffer(uint8_t value)
{
  writeScreenBuffer(value, 0xFF);
}

/**
 * @brief 将指定的黑白值写入屏幕缓冲区
 */
void GxEPD2_768c_GDEM076F55::writeScreenBuffer(uint8_t black_value, uint8_t color_value)
{
 ...
 * @brief 向屏幕写入单色位图
 */
void GxEPD2_768c_GDEM076F55::writeImage(const uint8_t bitmap[], int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  Serial.println("writeImage("); Serial.print(invert); Serial.print(mirror_y);
 ...
 * @brief 向屏幕写入黑白和彩色位图
 */
void GxEPD2_768c_GDEM076F55::writeImage(const uint8_t* black, const uint8_t* color, int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  Serial.println("writeImage1("); Serial.print(invert); Serial.print(mirror_y);
 ...
 * @brief 写入部分位图到屏幕
 */
void GxEPD2_768c_GDEM076F55::writeImagePart(const uint8_t bitmap[], int16_t x_part, int16_t y_part, int16_t w_bitmap, int16_t h_bitmap,
    int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  Serial.println("writeImagePart("); Serial.print(invert); Serial.print(mirror_y);
...
/**
 * @brief 写入部分黑白和彩色位图到屏幕
 */
void GxEPD2_768c_GDEM076F55::writeImagePart(const uint8_t* black, const uint8_t* color, int16_t x_part, int16_t y_part, int16_t w_bitmap, int16_t h_bitmap,
    int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  Serial.println("writeImagePart1("); Serial.print(invert); Serial.print(mirror_y);
  //Serial.print("writeImagePart("); Serial.print(x_part); Serial.print(", "); Serial.print(y_part); Serial.print(", ");
  //Serial.print(w_bitmap); Serial.print(", "); Serial.print(h_bitmap); Serial.print(", ");
  //Serial.print(x); Serial.print(", "); Serial.print(y); Serial.print(", ");
  //Serial.print(w); Serial.print(", "); Serial.print(h); Serial.println(")");
 ...
 * @brief 写入原生数据到屏幕
 */
void GxEPD2_768c_GDEM076F55::writeNative(const uint8_t* data1, const uint8_t* data2, int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  Serial.println("writeNative("); Serial.print(invert); Serial.print(mirror_y);
  if (!data1) return;
 ...
 * @brief 写入部分原生数据到屏幕
 */
void GxEPD2_768c_GDEM076F55::writeNativePart(const uint8_t* data1, const uint8_t* data2, int16_t x_part, int16_t y_part, int16_t w_bitmap, int16_t h_bitmap,
    int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  Serial.println("writeNative1("); Serial.print(invert); Serial.print(mirror_y);
  if (!data1) return;
  delay(1); // yield() to avoid WDT on ESP8266 and ESP32
  if (!_init_display_done) _InitDisplay();
  if (_initial_write) writeScreenBuffer();
 ...
 * @brief 绘制图像并刷新显示
 */
void GxEPD2_768c_GDEM076F55::drawImage(const uint8_t bitmap[], int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
 ...
 * @brief 绘制部分图像并刷新显示
 */
void GxEPD2_768c_GDEM076F55::drawImagePart(const uint8_t bitmap[], int16_t x_part, int16_t y_part, int16_t w_bitmap, int16_t h_bitmap,
    int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
 ...
 * @brief 绘制黑白彩色图像并刷新显示
 */
void GxEPD2_768c_GDEM076F55::drawImage(const uint8_t* black, const uint8_t* color, int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
...
/**
 * @brief 绘制黑白彩色部分图像并刷新显示
 */
void GxEPD2_768c_GDEM076F55::drawImagePart(const uint8_t* black, const uint8_t* color, int16_t x_part, int16_t y_part, int16_t w_bitmap, int16_t h_bitmap,
    int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
 ...
 * @brief 绘制原生数据并刷新显示
 */
void GxEPD2_768c_GDEM076F55::drawNative(const uint8_t* data1, const uint8_t* data2, int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
 ...
 * @brief 刷新整个屏幕或部分区域
 */
void GxEPD2_768c_GDEM076F55::refresh(bool partial_update_mode)
{
 ...
 * @brief 刷新指定区域
 */
void GxEPD2_768c_GDEM076F55::refresh(int16_t x, int16_t y, int16_t w, int16_t h)
{
 ...
 * @brief 关闭电源
 */
void GxEPD2_768c_GDEM076F55::powerOff()
{
  _PowerOff();
}
 ...
 * @brief 进入休眠模式
 */
void GxEPD2_768c_GDEM076F55::hibernate()
{
  _PowerOff();
  if (_rst >= 0)
  {
 ...
 * @brief 设置分页模式
 */
void GxEPD2_768c_GDEM076F55::setPaged()
{
  if (!hasPartialUpdate)
  {
    _paged = true;
 ...
 * @brief 执行刷新操作
 */
void GxEPD2_768c_GDEM076F55::_refresh(bool partial_update_mode)
{
 ...
 * @brief 设置部分RAM区域
 */
void GxEPD2_768c_GDEM076F55::_setPartialRamArea(uint16_t x, uint16_t y, uint16_t w, uint16_t h, bool partial_mode)
{
 ...
 * @brief 开启电源
 */
void GxEPD2_768c_GDEM076F55::_PowerOn()
{
  if (!_power_is_on)
  {
    _writeCommand(0x04);
 ...
 * @brief 关闭电源
 */
void GxEPD2_768c_GDEM076F55::_PowerOff()
{
  if (_power_is_on)
  {
    _writeCommand(0x02);
 ...
 * @brief 初始化显示控制器
 */
void GxEPD2_768c_GDEM076F55::_InitDisplay()
{
  ...
  Serial.println("_InitDisplay OK");
}

/**
 * @brief 反转数据位
 */
uint8_t GxEPD2_768c_GDEM076F55::_invert(uint8_t data)
{
  Serial.println("_invert 11");
  uint8_t result = 0x00;
  for (int i = 0; i < 4; i++)
  {
    switch (data & 0x03)
